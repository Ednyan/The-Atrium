...
export const DELETION_CODE_COPY = {
  en: {
    ...
    body: 'We received a request for your account deletion at The Digital Atrium. Enter the code below to confirm.\n\nThe code lasts 10 minutes. Nothing has been deleted yet.',
  ...
  es: {
    ...
    body: 'Hemos recibido una solicitud para eliminar tu cuenta en The Digital Atrium. Introduce el código de abajo para confirmarlo.\n\nEl código dura 10 minutos. Todavía no se ha eliminado nada.',
  ...
  'pt-BR': {
    ...
    body: 'Recebemos um pedido de exclusão da sua conta no Digital Atrium. Digite o código abaixo para confirmar.\n\nO código vale por 10 minutos. Nada foi excluído ainda.',
  ...
  'pt-PT': {
    ...
    greeting: (name: string) => `Olá ${name},`,
    body: 'Recebemos um pedido de eliminação da tua conta no Digital Atrium. Introduz o código abaixo para confirmar.\n\nO código dura 10 minutos. Ainda não foi eliminado nada.',
  ...
  fr: {
    ...
    body: 'Nous avons reçu une demande de suppression de votre compte sur The Digital Atrium. Saisissez le code ci-dessous pour confirmer.\n\nLe code est valable 10 minutes. Rien n’a encore été supprimé.',
  ...
  de: {
    ...
    body: 'Wir haben eine Anfrage zur Löschung deines Kontos bei The Digital Atrium erhalten. Gib den Code unten ein, um das zu bestätigen.\n\nDer Code gilt 10 Minuten. Es wurde noch nichts gelöscht.',
  ...
  it: {
    ...
    body: 'Abbiamo ricevuto una richiesta di eliminazione del tuo account su The Digital Atrium. Inserisci il codice qui sotto per confermare.\n\nIl codice dura 10 minuti. Non è ancora stato eliminato niente.',
  ...
  ru: {
    ...
    body: 'Мы получили запрос на удаление вашей учётной записи в The Digital Atrium. Введите код ниже, чтобы подтвердить.\n\nКод действует 10 минут. Пока ничего не удалено.',
  ...
  zh: {
    ...
    body: '我们收到了删除你在 The Digital Atrium 账号的请求。请输入下面的验证码来确认。\n\n验证码 10 分钟内有效。目前还没有删除任何东西。',
  ...
  ja: {
    ...
    body: 'The Digital Atrium のアカウント削除の要求を受け取りました。確認のため、下のコードを入力してください。\n\nコードの有効期限は 10 分です。まだ何も削除されていません。',
  ...
  ko: {
    ...
    body: 'The Digital Atrium 계정 삭제 요청을 받았습니다. 확인하려면 아래 코드를 입력해 주세요.\n\n코드는 10분 동안 유효합니다. 아직 삭제된 것은 없습니다.',
